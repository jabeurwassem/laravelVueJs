<template>
    <div class="card">
        <Toolbar class="bg-gray-900 shadow-2" style="border-radius: 3rem;background-image: linear-gradient(to right, #3498db, #6ab7ff, #2980b9)">
            <template #start>
            ...
            <template #end>
                <div class="flex align-items-center gap-2">
                    <span classe="admin">JABEUR LOCATION </span>
