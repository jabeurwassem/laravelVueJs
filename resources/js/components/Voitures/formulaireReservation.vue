<template>
  <form @submit.prevent="handleSubmit">
    <div class="card" style="width: 50rem">
      <div class="card-body">
        <span class="amount"
          >{{ $store.state.Voiturestore.cartTotal }}
...
const stripePromise = loadStripe(
  "pk_test_51OM8V8JxZFMHIckAjqpc8QTEjLbfXvccyitHo76LTIt5wlbhe5jFPJh6HCGBSL33JXvb8MkLTxgGUmCx5NegUeQF00AgEelI1N"
);
...
const handleSubmit = async () => {
  ...
  if (error) {
    ...
    //faire l appel à la creation d une location
